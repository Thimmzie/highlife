...
const Simulation = () => {
  ...
  return (
    <div className="p-6 space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-slate-800 font-dmsans dark:text-white">
          Simulation Panel
        </h1>
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1 font-dmsans">
      ...
      <div className="p-4 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-700 space-y-4">
        {[
          ...
          <div key={item.label}>
            <p className="text-sm mb-1 font-dmsans dark:text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="h-64 p-4 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-700">
          <h2 className="text-lg font-bold mb-4 text-slate-800 dark:text-white font-dmsans">
            Energy Trend
          </h2>
          ...
          {insights.map((msg, idx) => {
            switch (msg) {
              case 'Your energy drops due to low sleep':
                return (
                  <li className="font-dmsans dark:text-white" key={idx}>
              ...
              case 'Your habits look balanced today!':
                return (
                  <li className="font-dmsans dark:text-white" key={idx}>
                    Your habits are balanced today! Keep it up.
                  </li>
                );
              default:
                return (

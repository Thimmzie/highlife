...
const login = () => {
  return (
    <>
      <div className="bg-[#ffff] h-[100vh] flex flex-col items-center justify-center gap-10 px-12">
        ...
        <div className="min-h-[330px] w-full rounded-2xl border border-[#3b3b3b] px-3 outline-0 flex flex-col items-center justify-center">
          <button className="flex justify-center items-center gap-3 w-full border border-[#bdbdbd] h-[7vh] rounded-lg bg-[#2f0474] text-[#ffff] cursor-pointer">
            <FcGoogle size={25} />
            <p className="text-[0.9rem] lg:text-[0.8rem] font-inter">
              Continue with Google
            </p>
          </button>

          <p className="text-[0.8rem] mt-6 text-gray-700 lg:text-[0.7rem] whitespace-nowrap font-inter">
            Or continue with
          </p>
          ...
          <p className="mt-6 text-[0.7rem] font-inter">
